...
1. **Give them the installer.** It ships WITH this skill: `claude-packager.mcpb` in this
   ...
   fallback: https://github.com/dataPhysicist/toolbelt-for-claude/raw/main/dist/claude-packager.mcpb
